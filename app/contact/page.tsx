            ...
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="rounded-[26px] border border-white/10 bg-white/[0.04] p-8 md:p-10">
                ...
                <form className="mt-8 space-y-6">
                  ...
                  <button
                    type="submit"
                    className="rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 px-8 py-4 font-body font-semibold text-white transition-transform hover:scale-[1.02]"
                  >
                    Send Message
                  </button>
...
<section className="px-6 pb-24">
  <div className="container">
    ...
    <div className="rounded-[26px] border border-white/10 bg-white/[0.04] px-8 py-16 md:px-12">
      ...
      {/* ===================================================
          CONNECT WITH US — CENTERED CONTENT
          =================================================== */}
